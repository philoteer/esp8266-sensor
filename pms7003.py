#source: https://github.com/pkucmus/micropython-pms7003
import machine
import struct
import time
...
class Pms7003:
    ...
    def __init__(self,SoftUART_TX,SoftUART_RX):
        #self.uart = machine.SoftUART(UART_TX,UART_RX, baudrate=9600, bits=8, parity=None, stop=1)
        self.uart = machine.SoftUART(SoftUART_TX,SoftUART_RX, baudrate=9600) 
